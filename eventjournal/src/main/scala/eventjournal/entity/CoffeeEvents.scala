...
case class OrderAccepted(instant: Instant, orderInfo: OrderInfo)                                    extends CoffeeEvent
...
case class OrderFailedBeansNotAvailable(instant: Instant, orderId: OrderId, beanOrigin: BeanOrigin) extends CoffeeEvent
